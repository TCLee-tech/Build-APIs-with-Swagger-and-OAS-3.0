...
- Below is a list of screengrabs from Angular client app to show what you should be looking at on client-side:
...
- Below is a list of screengrabs showing server-side API implementation:
